...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { email: @developer.email, name: @developer.name } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { email: @developer.email, name: @developer.name } }
